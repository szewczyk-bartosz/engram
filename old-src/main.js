...
if (savedSerif)
  document.documentElement.style.setProperty("--serif", savedSerif);
  ...
  if (node["type"] === "folder") {
    ...
    label.addEventListener("click", () => {
      children.dataset.collapsed =
        children.dataset.collapsed === "true" ? "false" : "true";
    });
...
document.getElementById("filter").addEventListener("input", (e) => {
  ...
  document
    .querySelectorAll(".tree-node[data-type='file']")
    .forEach((el) => (el.style.display = "none"));
  // hide all folders
  document
    .querySelectorAll(".tree-node[data-type='folder']")
    .forEach((el) => (el.style.display = "none"));
